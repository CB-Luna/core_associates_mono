...
async function main() {
    ...
    const proveedoresData = [
        { idUnico: 'PRV-0001', razonSocial: 'Taller Mec\u00e1nico El R\u00e1pido', tipo: 'taller', direccion: 'Av. Insurgentes Sur #1234, Col. Del Valle, CDMX', latitud: 19.3755, longitud: -99.1687, telefono: '+525512345678', email: 'contacto@elrapido.com', contactoNombre: 'Carlos M\u00e9ndez' },
        { idUnico: 'PRV-0002', razonSocial: 'Cocina Do\u00f1a Mary', tipo: 'comida', direccion: 'Calle Sur #45, Col. Roma Norte, CDMX', latitud: 19.4195, longitud: -99.1616, telefono: '+525598765432', email: 'contacto@donamary.com', contactoNombre: 'Mar\u00eda L\u00f3pez' },
        { idUnico: 'PRV-0003', razonSocial: 'Despacho Jur\u00eddico Lex', tipo: 'abogado', direccion: 'Av. Reforma #567, Col. Ju\u00e1rez, CDMX', latitud: 19.4270, longitud: -99.1580, telefono: '+525555123456', email: 'contacto@lexabogados.com', contactoNombre: 'Lic. Roberto Hern\u00e1ndez' },
        { idUnico: 'PRV-0004', razonSocial: 'AutoLavado Express', tipo: 'lavado', direccion: 'Calz. de Tlalpan #890, Col. Portales, CDMX', latitud: 19.3615, longitud: -99.1440, telefono: '+525556789012', email: 'autolavado@express.com', contactoNombre: 'Pedro Ram\u00edrez' },
        { idUnico: 'PRV-0005', razonSocial: 'Capacitaci\u00f3n Vial MX', tipo: 'capacitacion', direccion: 'Av. Universidad #321, Col. Narvarte, CDMX', latitud: 19.3890, longitud: -99.1550, telefono: '+525534567890', email: 'info@capacitacionvial.mx', contactoNombre: 'Ana Mart\u00ednez' },
        { idUnico: 'PRV-0006', razonSocial: 'Taller de Carrocer\u00eda Don Beto', tipo: 'taller', direccion: 'Eje Central #456, Col. Doctores, CDMX', latitud: 19.4120, longitud: -99.1448, telefono: '+525578901234', email: 'donbeto@talleres.com', contactoNombre: 'Alberto Vega' },
        { idUnico: 'PRV-0007', razonSocial: 'Restaurante Los Compadres', tipo: 'comida', direccion: 'Av. Coyoac\u00e1n #789, Col. Del Valle Sur, CDMX', latitud: 19.3685, longitud: -99.1630, telefono: '+525567890123', email: 'reservas@loscompadres.mx', contactoNombre: 'Javier Torres' },
        { idUnico: 'PRV-0008', razonSocial: 'Abogados Asociados del Centro', tipo: 'abogado', direccion: 'Av. 5 de Mayo #234, Centro Hist\u00f3rico, CDMX', latitud: 19.4341, longitud: -99.1386, telefono: '+525589012345', email: 'contacto@abogadoscentro.com', contactoNombre: 'Lic. Patricia G\u00f3mez' },
    ];
    const proveedores = [];
    ...
    // ── ASOCIADOS ──
    const asociadosData = [
        { idUnico: 'ASC-0001', nombre: 'Juan', apellidoPat: 'P\u00e9rez', apellidoMat: 'Garc\u00eda', telefono: '+525510000001', email: 'juan.perez@email.com', fechaNacimiento: new Date('1990-03-15'), estado: 'activo' },
        { idUnico: 'ASC-0002', nombre: 'Mar\u00eda', apellidoPat: 'Gonz\u00e1lez', apellidoMat: 'L\u00f3pez', telefono: '+525510000002', email: 'maria.gonzalez@email.com', fechaNacimiento: new Date('1985-07-22'), estado: 'activo' },
        { idUnico: 'ASC-0003', nombre: 'Roberto', apellidoPat: 'Hern\u00e1ndez', apellidoMat: 'Mart\u00ednez', telefono: '+525510000003', email: 'roberto.hdez@email.com', fechaNacimiento: new Date('1992-11-08'), estado: 'activo' },
        { idUnico: 'ASC-0004', nombre: 'Ana Luc\u00eda', apellidoPat: 'Ram\u00edrez', apellidoMat: 'Soto', telefono: '+525510000004', email: 'ana.ramirez@email.com', fechaNacimiento: new Date('1988-01-30'), estado: 'activo' },
        { idUnico: 'ASC-0005', nombre: 'Carlos', apellidoPat: 'Mendoza', apellidoMat: 'R\u00edos', telefono: '+525510000005', email: 'carlos.mendoza@email.com', fechaNacimiento: new Date('1995-05-12'), estado: 'activo' },
        { idUnico: 'ASC-0006', nombre: 'Patricia', apellidoPat: 'Vega', apellidoMat: 'Cruz', telefono: '+525510000006', email: 'patricia.vega@email.com', fechaNacimiento: new Date('1993-09-18'), estado: 'activo' },
        { idUnico: 'ASC-0007', nombre: 'Miguel \u00c1ngel', apellidoPat: 'Torres', apellidoMat: 'D\u00edaz', telefono: '+525510000007', email: 'miguel.torres@email.com', fechaNacimiento: new Date('1987-04-25'), estado: 'activo' },
        { idUnico: 'ASC-0008', nombre: 'Fernanda', apellidoPat: 'Morales', apellidoMat: 'Jim\u00e9nez', telefono: '+525510000008', email: 'fernanda.morales@email.com', fechaNacimiento: new Date('1991-12-03'), estado: 'activo' },
        { idUnico: 'ASC-0009', nombre: 'Diego', apellidoPat: 'Castillo', apellidoMat: 'Rojas', telefono: '+525510000009', email: 'diego.castillo@email.com', fechaNacimiento: new Date('1994-08-14'), estado: 'pendiente' },
        { idUnico: 'ASC-0010', nombre: 'Gabriela', apellidoPat: 'Flores', apellidoMat: 'Ortiz', telefono: '+525510000010', email: 'gabriela.flores@email.com', fechaNacimiento: new Date('1989-06-27'), estado: 'pendiente' },
        { idUnico: 'ASC-0011', nombre: 'Andr\u00e9s', apellidoPat: 'Reyes', apellidoMat: 'Luna', telefono: '+525510000011', email: 'andres.reyes@email.com', fechaNacimiento: new Date('1996-02-09'), estado: 'pendiente' },
        { idUnico: 'ASC-0012', nombre: 'Laura', apellidoPat: 'Dom\u00ednguez', apellidoMat: 'N\u00fa\u00f1ez', telefono: '+525510000012', email: 'laura.dominguez@email.com', fechaNacimiento: new Date('1986-10-20'), estado: 'suspendido' },
    ];
    const asociados = [];
    ...
    const promocionesData = [
        { proveedorIdx: 0, titulo: '20% en Servicio Mayor', descripcion: 'Descuento del 20% en servicio mayor completo incluyendo cambio de aceite, filtros y revisi\u00f3n de frenos.', tipoDescuento: 'porcentaje', valorDescuento: 20, vigenciaCupon: 48, maxCupones: 100, estado: 'activa' },
        { proveedorIdx: 0, titulo: '$200 de Descuento en Afinaci\u00f3n', descripcion: 'Descuento de $200 pesos en afinaci\u00f3n completa de 4 o 6 cilindros.', tipoDescuento: 'monto_fijo', valorDescuento: 200, vigenciaCupon: 72, maxCupones: 50, estado: 'activa' },
        { proveedorIdx: 1, titulo: '15% en Comidas', descripcion: 'Descuento del 15% en cualquier platillo del men\u00fa. Incluye desayunos, comidas y cenas.', tipoDescuento: 'porcentaje', valorDescuento: 15, vigenciaCupon: 24, maxCupones: 200, estado: 'activa' },
        { proveedorIdx: 3, titulo: 'Lavado Premium $99', descripcion: 'Lavado completo exterior e interior con encerado y aromatizado por solo $99 (precio regular $199).', tipoDescuento: 'monto_fijo', valorDescuento: 100, vigenciaCupon: 48, maxCupones: 150, estado: 'activa' },
        { proveedorIdx: 4, titulo: '30% en Curso de Manejo Defensivo', descripcion: 'Descuento del 30% en el curso completo de manejo defensivo (16 horas). Incluye certificado.', tipoDescuento: 'porcentaje', valorDescuento: 30, vigenciaCupon: 168, maxCupones: 30, estado: 'activa' },
        { proveedorIdx: 5, titulo: '25% en Reparaci\u00f3n de Carrocer\u00eda', descripcion: 'Descuento del 25% en cualquier trabajo de hojalatera y pintura. Presupuesto sin compromiso.', tipoDescuento: 'porcentaje', valorDescuento: 25, vigenciaCupon: 72, maxCupones: 40, estado: 'activa' },
        { proveedorIdx: 6, titulo: '2x1 en Comida Corrida', descripcion: 'Al presentar el cup\u00f3n, obt\u00e9n 2 comidas corridas por el precio de 1. De lunes a viernes.', tipoDescuento: 'porcentaje', valorDescuento: 50, vigenciaCupon: 24, maxCupones: 100, estado: 'activa' },
        { proveedorIdx: 0, titulo: '10% en Refacciones', descripcion: 'Descuento del 10% en todas las refacciones y partes automotrices disponibles.', tipoDescuento: 'porcentaje', valorDescuento: 10, vigenciaCupon: 48, maxCupones: 80, estado: 'pausada' },
    ];
    const promociones = [];
    ...
    for (let i = 0; i < 8; i++) {
        ...
        const qrFirma = (0, crypto_1.createHmac)('sha256', HMAC_SECRET).update(qrPayload).digest('hex').substring(0, 128);
        const venc = new Date();
    ...
    const casosData = [
        { asociadoIdx: 0, tipoPercance: 'accidente', descripcion: 'Choque por alcance en Perif\u00e9rico Sur a la altura de San Jer\u00f3nimo. Da\u00f1os en la parte trasera del veh\u00edculo.', latitud: 19.3453, longitud: -99.1890, direccionAprox: 'Perif\u00e9rico Sur, Col. San Jer\u00f3nimo, CDMX', estado: 'abierto', prioridad: 'alta' },
        { asociadoIdx: 1, tipoPercance: 'infraccion', descripcion: 'Infracci\u00f3n por supuesta vuelta prohibida en Eje Central y Fray Servando.', latitud: 19.4230, longitud: -99.1440, direccionAprox: 'Eje Central y Fray Servando, CDMX', estado: 'en_atencion', prioridad: 'media' },
        { asociadoIdx: 2, tipoPercance: 'asalto', descripcion: 'Asalto a mano armada mientras esperaba pasaje en la zona de Tepito. Le robaron celular y efectivo.', latitud: 19.4427, longitud: -99.1210, direccionAprox: 'Col. Morelos, cerca de Tepito, CDMX', estado: 'en_atencion', prioridad: 'urgente' },
        { asociadoIdx: 3, tipoPercance: 'accidente', descripcion: 'Colisi\u00f3n lateral con taxi en el cruce de Reforma y Bucareli. Testigos presentes.', latitud: 19.4270, longitud: -99.1510, direccionAprox: 'Reforma y Bucareli, Col. Ju\u00e1rez, CDMX', estado: 'resuelto', prioridad: 'alta' },
        { asociadoIdx: 4, tipoPercance: 'robo', descripcion: 'Robo de autopartes (espejos laterales y emblema) durante la noche. El veh\u00edculo estaba estacionado.', latitud: 19.3980, longitud: -99.1570, direccionAprox: 'Col. Narvarte Poniente, CDMX', estado: 'abierto', prioridad: 'media' },
        { asociadoIdx: 5, tipoPercance: 'infraccion', descripcion: 'Multa por Hoy No Circula. El asociado alega que su holograma est\u00e1 vigente.', latitud: 19.4100, longitud: -99.1670, direccionAprox: 'Viaducto Miguel Alem\u00e1n, CDMX', estado: 'escalado', prioridad: 'baja' },
        { asociadoIdx: 6, tipoPercance: 'accidente', descripcion: 'Bache caus\u00f3 da\u00f1o en suspensi\u00f3n delantera. Se levant\u00f3 reporte a la delegaci\u00f3n.', latitud: 19.3550, longitud: -99.1300, direccionAprox: 'Calz. de Tlalpan, Col. Country Club, CDMX', estado: 'cerrado', prioridad: 'baja' },
        { asociadoIdx: 7, tipoPercance: 'otro', descripcion: 'Problema con la app de plataforma que desactiv\u00f3 su cuenta sin explicaci\u00f3n. Necesita asesor\u00eda laboral.', latitud: 19.4326, longitud: -99.1332, direccionAprox: 'Centro Hist\u00f3rico, CDMX', estado: 'resuelto', prioridad: 'media' },
    ];
    const casos = [];
