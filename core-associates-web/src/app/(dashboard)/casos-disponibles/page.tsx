...
import { Car, Gavel, ShieldAlert, AlertTriangle, HelpCircle, Calendar, Hand } from 'lucide-react';
...
export default function CasosDisponiblesPage() {
  ...
  const columns: ColumnDef<CasoLegal, any>[] = [
    ...
    },
    {
      ...
      header: 'Ubicación',
      cell: ({ row }) => (
        <span className="truncate text-xs text-gray-500">{row.original.direccionAprox || 'Sin dirección'}</span>
      ),
    },
    {
